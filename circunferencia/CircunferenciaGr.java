...
public class CircunferenciaGr extends Circunferencia
{
   ...
   /**
    * CircunferenciaGr Construtor
    *
    * @param pontoCentralX int. Coordenada x1
    * @param pontoCentralY int. Coordenada y1
    * @param x2 int. Coordenada x2
    * @param y2 int. Coordenada y2
    */
   public CircunferenciaGr(int pontoCentralX, int pontoCentralY, int x2, int y2){
    ...
    /**
     * Método setReferencia
     *
     * @param xRef int. Coordenada x2
     * @param yRef int. Coordenada y2
     */
    ...
    /**
     * Método getReferencia
     *
     * @return Ponto. Ponto p2(x2,y2)
     */
   ...
   /**
    * Método desenharCirculo1
    * Desenha o circulo a partir da equacao reduzida
    * @param g. Classe com os metodos graficos do Java
    */
   public void desenharCirculoEquacao(Graphics g){
       ...
       /**
        * Método desenharCirculo2
        * Desenha o circulo a partir dos angulos
        * @param g Classe com os metodos graficos do Java
        */
       public void desenharCirculoAng(Graphics g){
