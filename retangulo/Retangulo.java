...
public class Retangulo
{
    ...
    public Retangulo(int x1, int y1, int x2, int y2) {
        ...
        setD3(new Ponto(x1, y2));
        setD4(new Ponto(x2,y1));
    }
    ...
    public Retangulo(Ponto p1, Ponto p2) {
        setD1(p1);
        setD2(p2);
        setD3(new Ponto(p1.getX(), p2.getY()));
        setD4(new Ponto(p2.getX(), p1.getY()));
    }
    ...
    public void setD2(Ponto p2){
     ...
     /**
      * Altera valor de d3 de acordo com o parametro
      *
      * @param p valor de d3 (externo)
      */
     public void setD3(Ponto p3){
        this.d3 = p3;
    }
    
     /**
      * Altera valor de d4 de acordo com o parametro
      *
      * @param p valor de d4 (externo)
      */
     public void setD4(Ponto p4){
        this.d4 = p4;
    }
