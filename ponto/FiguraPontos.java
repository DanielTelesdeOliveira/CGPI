...
public class FiguraPontos {
     ...
     *
     * @param biblioteca grafica para desenhar elementos gráficos
     * @param pref Ponto a ser desenhado
     */
    public static void desenharPonto(Graphics g, PontoGr pref){
        pref.desenharPonto(g);
    }
